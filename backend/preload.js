...
contextBridge.exposeInMainWorld('lsAPI', {
  //=================================================================================================
...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  send: (channel, data) => {
    const validChannels = ['scrapedData:export', 'logs:clear', 'open-scrape-window'];
  ...
  // ADDED: openScrapeWindow => calls 'open-scrape-window'
  openScrapeWindow: (url) => {
    console.log('electronAPI.openScrapeWindow called with url:', url);
    // Instead of "this.send(...)": directly call the above function or do ipcRenderer.send
...
// The "urlScrape" context remains for webview usage
