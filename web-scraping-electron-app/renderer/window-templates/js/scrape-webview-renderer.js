...
function enableManImportBtn() {
  $('#man-importCombBtn').prop('disabled', false).removeClass('element-disabled');
}
...
function disableManImportBtn() {
  $('#man-importCombBtn').prop('disabled', true).addClass('element-disabled');
}
...
function enableAutoImportBtns() {
  $('#auto-importCombBtn').prop('disabled', false).removeClass('element-disabled');
  $('#auto-importSepBtn').prop('disabled', false).removeClass('element-disabled');
}
...
function disableAutoImportBtns() {
  $('#auto-importCombBtn').prop('disabled', true).addClass('element-disabled');
  $('#auto-importSepBtn').prop('disabled', true).addClass('element-disabled');
}
...
function hotKeySettingChanging() {
  ...
  $('#hotkey-change-btn').css('pointer-events', 'none').css('cursor', 'default');
}
...
function hotKeySettingNormal() {
  ...
  $('#hotkey-change-btn').css('pointer-events', '').css('cursor', '');
}
