...
contextBridge.exposeInMainWorld(
    'electronAPI', {    // Expose a safe API for IPC communication between renderer and main processes
        ...
        send: (channel, data) => {
            ...
            const validChannels = ['open-url', 'exit:request', 'log-info', 'log-debug',
            'log-warn', 'log-error', 'openLSExternal:request', 'scrapedData:export'];
        ...
        receive: (channel, func) => {
            ...
            'updateToProjectList', 'exportData:response', 'scrapedData:update'];
